    ...
    <div class="row align-items-start">
      <div class="col-sm-5" id="price">
        <div class="input-group-sm">
          ...
          <input id="prixmin" class="form-range" name="prixmin" type="range" min="0" max="25000" step="500" value="500">
      ...
      <div class="col-sm-5" id="kilometer">
        <div class="input-group-sm">
          ...
          <input id="kmmin" class="form-range" name="kmmin" type="range" min="0" max="100000" step="1000" value="1000">
