...
<span class="badge text-bg-<?php echo $badge; ?>"><?php echo $statut; ?></span>
  ...
  <a href="<?php echo BASE_URL; ?>/administration/voitures/infos/<?php echo $id; ?>" class="button">En savoir plus</a>
</div>